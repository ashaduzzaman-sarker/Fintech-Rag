...
class IngestionPipeline:
    ...
    def __init__(
        ...
        self.chunker = (
            AdvancedSemanticChunker() if use_advanced_chunking
        ...
        logger.info(
            ...
            extra={"advanced_chunking": use_advanced_chunking}
        )
    ...
    def process_directory(
        ...
        try:
            ...
            self.stats["total_tokens"] = sum(
                doc.metadata.get("chunk_tokens", 0)
            ...
            logger.info(
                ...
                extra={
                    **self.stats,
                    "avg_chunks_per_file": self.stats["total_chunks"] / max(1, self.stats["total_files"]),
                    "docs_per_second": self.stats["total_chunks"] / max(1, self.stats["processing_time"])
                }
            )
