...
SAMPLE_DOCUMENTS = [
    Document(
        ...
        """,
        metadata={"source": "aml_policy.pdf", "page": 1, "category": "compliance"},
    ),
    Document(
        page_content="""
        ...
        """,
        metadata={"source": "basel_iii.pdf", "page": 1, "category": "compliance"},
    ),
    Document(
        page_content="""
        KYC PROCEDURES
        ...
        """,
        metadata={"source": "kyc_procedures.pdf", "page": 1, "category": "compliance"},
    ),
]
